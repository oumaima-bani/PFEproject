Rails.application.routes.draw do
 ...
 #add registration (register page ) + confirmation de l'email
  ...
  get 'getoffrebydomain/:domain_id', to: 'offres#getoffrebydomain'
  get 'getoffrebydomain2/:domain_id', to: 'offres#getoffrebydomain2'
  get 'getoffrebydomain3/:domain_id', to: 'offres#getoffrebydomain3'
  get 'getalllocations', to: 'offres#getalllocations'
  get 'getoffrebybudget/:min_salary/:max_salary', to: 'offres#getoffrebybudget'
  get 'getoffrebybudget2/:min_salary/:max_salary', to: 'offres#getoffrebybudget2'
  get 'getoffrebybudget3/:min_salary/:max_salary', to: 'offres#getoffrebybudget3'
 ...
 #add get  condidature on  offre  by user (freelancer / Internship / employee) + by  admin(offre proprity ) by offre (on offre)
  ...
  get 'get_active_offre_by_freelance/:user_id', to: 'candidatures#get_active_offre_by_freelance'
  get 'get_ended_offre_by_freelance/:user_id', to: 'candidatures#get_ended_offre_by_freelance'
 ...
 #add get all users (for SuperAdmin) + Add update image to make our platforme with image
  ...
  get 'static_home', to: 'static#static_home'
  ...
  get 'get_candidates', to: 'users#get_candidates'
end
