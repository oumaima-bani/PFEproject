...
ActiveRecord::Schema[7.0].define(version: 2023_06_15_151847) do
  ...
  create_table "offres", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.uuid "user_id", null: false
    t.integer "candidatures_count", default: 0
  ...
  add_foreign_key "categories", "domains", on_delete: :cascade
  add_foreign_key "certifications", "users", on_delete: :cascade
  add_foreign_key "competences", "souscategories", column: "souscategorie_id", on_delete: :cascade
  add_foreign_key "competences", "users", on_delete: :cascade
  add_foreign_key "experiences", "users", on_delete: :cascade
  add_foreign_key "favoris", "offres", on_delete: :cascade
  add_foreign_key "favoris", "users", on_delete: :cascade
  add_foreign_key "formations", "users", on_delete: :cascade
  add_foreign_key "offre_categories", "offres", on_delete: :cascade
  add_foreign_key "offre_categories", "souscategories", column: "souscategorie_id", on_delete: :cascade
  add_foreign_key "offres", "users", on_delete: :cascade
  add_foreign_key "souscategories", "categories", column: "categorie_id", on_delete: :cascade
  add_foreign_key "user_langues", "langues", on_delete: :cascade
  add_foreign_key "user_langues", "users", on_delete: :cascade
end
